...
public class MainTest {
	...
	public void T1domainModelEqualsTest() {
		Agent agent1 = agentService.getAgent("paco@hotmail.com");
		Agent agent2 = agentService.getAgent("pac@hotmail.com");
		Agent agent3 = agentService.getAgent("paco@hotmail.com");
		Agent agent4 = agentService.getAgent("pepe@gmail.com");
